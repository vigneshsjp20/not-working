  ...
  return (
    <main className="fixed inset-0 h-[100svh] w-full bg-black text-white flex flex-col items-center justify-center overflow-hidden touch-none selection:bg-primary selection:text-primary-foreground">
      ...
      <div className="w-full h-full max-w-md mx-auto relative flex flex-col p-3 md:p-6 overflow-hidden">
        <header className="text-center mb-1 md:mb-4 shrink-0 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <p className="text-[9px] text-muted-foreground uppercase tracking-[0.2em] font-bold mt-0.5">Adventure with Ree ❤️</p>
        </header>
        ...
        <footer className="mt-1 md:mt-4 text-center shrink-0 animate-in fade-in duration-1000">
          <p className="text-[8px] text-white/20 uppercase tracking-[0.1em] font-bold italic">Interactive AI Experience</p>
        </footer>
      </div>
    </main>
  );
