...
export function FlagCard({ countryCode, className, isCorrect }: FlagCardProps) {
  ...
  return (
    <div className={cn(
      "glass p-4 rounded-3xl transition-all duration-300 relative overflow-hidden flex items-center justify-center",
      ...
      <div className="relative aspect-[3/2] w-full max-w-md shadow-2xl rounded-xl overflow-hidden border-4 border-white/50">
        <Image
          src={flagUrl}
          alt="Country Flag"
          fill
